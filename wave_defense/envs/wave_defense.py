...
class WaveDefense(gym.Env):
    def __init__(self):
            ...
            self.player = Player("../input/wave-defense-package/Wave-Defense-Learning-Environment-main/wave_defense/envs/resources/sprites/player.png", self.player_width, self.player_height, self.screen_width, self.screen_height)
