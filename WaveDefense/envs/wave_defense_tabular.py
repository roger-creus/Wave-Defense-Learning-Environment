...
class WaveDefenseTabular(gym.Env):
    def __init__(self):
            ...
            self.bg = pygame.image.load("./WaveDefense/envs/resources/sprites/black.jpg")
            ...
            self.player = Player("./WaveDefense/envs/resources/sprites/player.png", self.player_width, self.player_height, self.screen_width, self.screen_height)
